          ...
          <div className="w-full flex flex-wrap justify-between items-start gap-12 md:px-8 lg:px-40">
            ...
            <div className="flex justify-start items-center gap-6 sm:gap-12 w-full sm:w-[570px]">
              <label className="min-w-[120px] sm:min-w-[172px] text-[#737791] text-xl font-normal font-['Urbanist']" htmlFor="supplier-name">
                Supplier Name <span className="text-red-500 text-xl">*</span></label>
              <input
                id="supplier-name "
                type="text"
                placeholder="Enter here"
    ...
    <div className="flex justify-start items-center gap-6 sm:gap-12 w-full sm:w-[570px]">
      ...
      <label htmlFor="sameAsPhone" className="text-[#a1a5b6] text-base font-normal font-['Urbanist']">
        Same as Phone
            ...
            {/* Advance Deducted */}
            <div className="flex justify-start items-center gap-6 sm:gap-12 w-full sm:w-[570px]">
              <label className="min-w-[120px] sm:min-w-[172px] text-[#737791] text-xl font-normal font-['Urbanist']" htmlFor="advance-deducted">Advance Deducted</label>
     ...
     {/* Advance */}
     <div className="flex justify-start items-center gap-6 sm:gap-12 w-full sm:w-[570px]">
              <label className="min-w-[120px] sm:min-w-[172px] text-[#737791] text-xl font-normal font-['Urbanist']" htmlFor="advance">Advance</label>
              <div className="w-full sm:w-[350px] px-6 py-4 bg-gray-50 rounded-xl flex justify-start items-center gap-3">
                <span className="text-[#05004e] text-xl font-bold">$</span>
                <input
                  id="advance"
