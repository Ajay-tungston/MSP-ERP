...
const CashbookHeader = () => {
  ...
  const [openingBalance, setOpeningBalance] = useState(0); // 💰 Opening balance state
...
console.log(response)
      ...
      setOpeningBalance(response.data.openingBalance || 0); // 🟢 Set opening balance
    } catch (error) {
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="bg-blue-50 text-blue-600 font-medium px-4 py-2 rounded-md">
              $ {openingBalance.toFixed(2)} {/* 💵 Dynamic value */}
            </div>
          </div>
        </div>
