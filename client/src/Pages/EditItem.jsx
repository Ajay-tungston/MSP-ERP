...
//     const fetchItem = async () => {
//       try {
//         const res = await axiosInstance.get(`/admin/item/${itemId}`);
//         const { itemCode, itemName, conversionRatio } = res.data;
//         setItemCode(itemCode);
//         setItemName(itemName);
//         setConversionRatio(conversionRatio || 30);
//       } catch (err) {
//         Swal.fire({
...
//     try {
//       await axiosInstance.put(`/admin/item/${itemId}`, {
//         itemCode,
//         itemName,
//         conversionRatio,
//       });
...
//     } catch (error) {
//       Swal.fire({
//         title: error?.response?.data?.message || "Failed to update item",
//         icon: "error",
//       });
//     }
//   };
