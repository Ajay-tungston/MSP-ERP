...
function EditVehicle({ setPopup, fetchVehicles, vehicleToEdit }) {
  ...
  useEffect(() => {
    if (vehicleToEdit) {
      setFormData({
        ...
        vehicleNo: vehicleToEdit.vehicleNo || "",
        rcNo: vehicleToEdit.rcNo || "",
      });
    }
  }, [vehicleToEdit]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        const response = await axiosPrivate.put(
            `/admin/vehicle/update/${vehicleToEdit._id}`,
            formData
          );
