...
function Employe() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!employeeName) {
      ...
      newErrors.employeeName = 'Employee Name should be between 3 to 100 characters';
      formValid = false;
    }
    ...
    if (address && (address.length < 5 || address.length > 200)) {
      newErrors.address = 'Address should be between 5 to 200 characters if provided';
      formValid = false;
    }
    ...
    if (!joiningDate) {
      ...
      newErrors.joiningDate = 'Joining Date must be a valid date and cannot be in the future.';
      formValid = false;
    }
...
<div className="w-full sm:w-[570px] flex flex-col gap-1">
  ...
  <div className="flex justify-start items-center gap-6 sm:gap-12 w-full">
    {/* Label for WhatsApp */}
    <label className="w-[172px] sm:min-w-[172px] text-[#737791] text-xl font-normal font-['Urbanist']"
      htmlFor="whatsapp">
      WhatsApp
    </label>
...
<div className="w-full sm:w-[570px] flex flex-col gap-1">
  ...
  <div className="flex justify-start items-center gap-6 sm:gap-12 w-full">
    <label className="min-w-[120px] sm:min-w-[172px] text-[#737791] text-xl font-normal font-['Urbanist']" htmlFor="opening-balance">
      Opening Balance
    </label>
...
<div className="w-full sm:w-[570px] flex flex-col gap-1">
  ...
  <div className="flex justify-start items-center gap-6 sm:gap-12 w-full">
    <label className="min-w-[120px] sm:min-w-[172px] text-[#737791] text-xl font-normal font-['Urbanist']" htmlFor="joining-date">
    ...
    />
        ...
        <div className="w-full sm:w-[570px] flex flex-col gap-1">
          ...
          <div className="flex items-center gap-6 sm:gap-12 w-full">
            <label className="min-w-[120px] sm:min-w-[172px] text-[#737791] text-xl font-normal font-['Urbanist']" htmlFor="salary">
        ...
        <div className="flex flex-wrap justify-start sm:justify-end items-center gap-2 sm:gap-4 ml-auto">
          <button
            className="w-full sm:w-[175px] bg-blue-50 text-[#4078ec] text-center py-4 rounded-l-xl 
      hover:bg-blue-100 hover:text-blue-700 hover:scale-105 cursor-pointer transition-all duration-200"
          >
            Daily
          </button>
          <button
            className="w-full sm:w-[175px] bg-blue-50 text-[#4078ec] text-center py-4 rounded-r-xl 
      hover:bg-blue-100 hover:text-blue-700 hover:scale-105 cursor-pointer transition-all duration-200"
          >
            Monthly
          </button>
