        ...
        <>
            <div className={`p-4 rounded-lg shadow-sm h-[800px] bg-white mt-5 ${popup ? 'backdrop-blur-xl' : ''}`}>
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex space-x-3 -mt-10 mr-10" onClick={() => { setPopup(true); setEditData(null); }}>
                            ...
                            {isLoading ? (
                                ...
                                expenses.map((expense, index) => (
                                    <tr key={expense._id} className="border-b border-gray-200 hover:bg-gray-50">
                                        ...
                                        <td className="p-3 text-blue-800 cursor-pointer" onClick={() => handleEditClick(expense)}>
                                        <TbPencilMinus
  size={20}
  onClick={() => {
