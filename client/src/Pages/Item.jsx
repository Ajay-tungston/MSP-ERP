...
//       <div className=" h-fit relative bg-gray-50  outline-1 outline-offset-[-1px] outline-white overflow-hidden mt-10">      </div>

//       <div
//         className={`w-full   absolute bg-white rounded-3xl overflow-hidden ${
...
//         <div
//           className="w-80 h-[64px] px-6 py-4 left-[1143px] top-[32px] absolute bg-indigo-500 rounded-2xl inline-flex justify-center items-center gap-3"
...
//           </table>
//         </div>
//         <div className="left-[48px] top-[118px] absolute justify-start text-indigo-950 text-4xl font-bold font-['Urbanist'] leading-[50.40px]">
//           Item
//         </div>
...
//               className={`w-36 h-[64px] px-4 py-2 border border-gray-300 rounded-lg ${
//                 currentPage === 1
...
//       {popup && <AddItem setPopup={setPopup} />}
//     </div>
//   );
// }
  ...
  return (
    ...
    <div className="p-4 rounded-lg shadow-sm h-[800px] bg-white mt-5">
      ...
      <nav className="text-sm text-gray-500 mb-2 mt-10">
        <span>Master</span> <span className="mx-1">›</span> <span className="text-gray-700">Item</span>
      </nav>
