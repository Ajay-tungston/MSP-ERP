  ...
  return (
    <>
      <div className="h-fit relative bg-gray-50 outline-1 outline-offset-[-1px] outline-white mt-10">
        <div className="w-full h-[1095px] absolute bg-white rounded-3xl overflow-hidden">
          ...
          <div className="w-full left-0 top-[202px] absolute inline-flex flex-col justify-start items-start bg">
            {/* Header */}
            <div className="self-stretch px-12 py-4 bg-gray-50 border-b border-gray-200 inline-flex  items-center gap-25">
              <div className="min-w-32 justify-center text-indigo-950 text-xl font-bold font-['Urbanist'] tracking-wide bg">Category</div>
            ...
            {currentData.map((row, index) => (
              <div key={index} className="self-stretch px-1 py-4 bg-white border-b border-gray-200 inline-flex  items-center gap-25">
          ...
          {/* Pagination Controls */}
          <div className="screen px-12 py-6 left-0 top-[976px] absolute border-b border-gray-200 inline-flex justify-between items-center">
      ...
      {popup && <AddPaymentOut setPopup={setPopup} />}
    </>
  );
}
