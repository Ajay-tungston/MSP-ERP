...
<>
  ...
  Payment Out
            ...
            <div className="w-80 h-[64px] px-6 py-4 left-[1023px] top-[32px] absolute bg-indigo-500 rounded-2xl inline-flex justify-center items-center gap-3" onClick={()=>setPopup(true)}>
              ...
              <div className="justify-start text-white text-xl font-bold font-['Urbanist']">Payment Out</div>
            </div>
          </div>

          <div className="left-[48px] top-[80px] absolute justify-start text-indigo-950 text-4xl font-bold font-['Urbanist'] leading-[50.40px]">Payment Out</div>
