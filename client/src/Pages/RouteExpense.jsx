...
export default function Commission() {
  ...
  const commissions = [
    { id: '001', type: 'Transportation Fees', percentage: 'Credit', marketFee: '$150.00', logistics: '', avgKg: '' },
    { id: '002', type: 'Warehouse Rent', percentage: 'Debit', marketFee: '$500.00', logistics: '', avgKg: '' },
    { id: '003', type: 'Transportation Fees', percentage: 'Credit', marketFee: '$150.00', logistics: '', avgKg: '' },
    { id: '004', type: 'Warehouse Rent', percentage: 'Debit', marketFee: '$500.00', logistics: '', avgKg: '' },
    { id: '005', type: 'Transportation Fees', percentage: 'Credit', marketFee: '$150.00', logistics: '', avgKg: '' },
    { id: '006', type: 'Transportation Fees', percentage: 'Credit', marketFee: '$150.00', logistics: '', avgKg: '' },
    { id: '007', type: 'Warehouse Rent', percentage: 'Credit', marketFee: '$150.00', logistics: '', avgKg: '' },
    { id: '008', type: 'Warehouse Rent', percentage: 'Credit', marketFee: '$150.00', logistics: '', avgKg: '' },
  ];
  ...
  return (
    <div className="p-4 rounded-lg shadow-sm bg-white mt-5">
      <nav className="text-sm text-gray-500 mb-2 mt-10">
        <span>Master</span> <span className="mx-1">›</span> <span className="text-gray-700"></span>
      </nav>

      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-900">Route Expense</h1>
        <div className="flex space-x-3 -mt-10 mr-10">
          ...
          >
            <CiCirclePlus className="text-xl" /> Add New Route Expense
          </button>
        </div>
      </div>
