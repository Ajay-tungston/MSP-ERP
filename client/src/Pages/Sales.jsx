...
function Sales() {
    const customers = ['Farm Fresh', 'Organic Valley', 'Green Leaf'];
                ...
                <div className="w-[665px] h-full left-[1200px] top-[148px] absolute bg-[#EEEEEE]">
                    ...
                    <div className="w-[653px] left-[6px] top-[176px] absolute inline-flex flex-col justify-start items-start">
                        <div className="self-stretch px-2.5 py-4 bg-white  outline-[0.20px] outline-offset-[-0.20px] outline-slate-600/40 inline-flex justify-start items-center gap-[5px]">
                            <div className="flex-1 max-w-16 justify-center text-indigo-950 text-sm font-bold font-['Urbanist'] tracking-wide">No.</div>
                            <div className="min-w-32 justify-center text-indigo-950 text-sm font-bold font-['Urbanist'] tracking-wide">Item name</div>
                            <div className="min-w-32 justify-center text-indigo-950 text-sm font-bold font-['Urbanist'] tracking-wide">Qty (KG)</div>
                            <div className="min-w-32 justify-center text-indigo-950 text-sm font-bold font-['Urbanist'] tracking-wide">Unit</div>
                            <div className="min-w-32 justify-center text-indigo-950 text-sm font-bold font-['Urbanist'] tracking-wide">Unit Price</div>
                            <div className="w-20 justify-center text-indigo-950 text-sm font-bold font-['Urbanist'] tracking-wide">total</div>
                        </div>
                        <div className="self-stretch px-2.5 py-4 bg-white  outline-[0.20px] outline-offset-[-0.20px] outline-slate-600/40 inline-flex justify-start items-center gap-[5px]">
                            <div className="w-5 max-w-16 justify-center text-indigo-950 text-sm font-normal font-['Urbanist'] tracking-wide">01.</div>
                            <div className="min-w-32 justify-center text-indigo-950 text-sm font-normal font-['Urbanist'] tracking-wide">demo</div>
                            <div className="min-w-32 justify-center text-indigo-950 text-sm font-normal font-['Urbanist'] tracking-wide">2</div>
                            <div className="min-w-32 justify-center text-indigo-950 text-sm font-normal font-['Urbanist'] tracking-wide">-</div>
                            <div className="min-w-32 justify-center text-indigo-950 text-sm font-normal font-['Urbanist'] tracking-wide">$205</div>
                            <div className="w-20 justify-center text-indigo-950 text-sm font-normal font-['Urbanist'] tracking-wide">$25154</div>
                        </div>

               
                    </div>
                    <div className="w-96 pb-6 left-[6px] top-[122px] absolute border-b border-none inline-flex justify-start items-center gap-2.5">
                        <div className="justify-start text-indigo-950 text-3xl font-bold font-['Urbanist'] leading-10">Item list</div>
                    </div>
                </div>
                <div className="w-[865px] h-full left-[329px] top-[148px] absolute bg-[#EEEEEE] shadow-[0px_4px_5.800000190734863px_0px_rgba(0,0,0,0.25)]">
                    <div className="w-[782px] left-[44px] top-[80px] absolute inline-flex flex-col justify-start items-start gap-2.5">
                        <div className="inline-flex justify-start items-center gap-3">
                            <div className="justify-start text-slate-500 text-xl font-normal font-['Urbanist']">Transactions <span></span>Sales</div>
                        ...
                        <div className="self-stretch flex flex-col justify-start items-start gap-11">
                            <div className="self-stretch pb-6 border-b border-zinc-100 inline-flex justify-start items-center gap-2.5">
                                <div className="justify-start text-indigo-950 text-3xl font-bold font-['Urbanist'] leading-10">Sales register</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="self-stretch flex flex-col justify-start items-start ">
                       <div className="self-stretch flex flex-col justify-start items-start">
                                   ...
                                   <div className="self-stretch px-2.5 py-4 relative bg-white border-t-[0.20px] border-b-[0.20px] border-slate-600/40 inline-flex justify-start items-center gap-3.5">
                                       <div className="flex-1 max-w-16 justify-center text-indigo-950 text-sm font-bold font-['Urbanist'] tracking-wide">No.</div>
                                       <div className="min-w-32 justify-center text-indigo-950 text-sm font-bold font-['Urbanist'] tracking-wide">Customer</div>
                                       <div className="min-w-32 justify-center text-indigo-950 text-sm font-bold font-['Urbanist'] tracking-wide">Item name</div>
                                       <div className="min-w-32 justify-center text-indigo-950 text-sm font-bold font-['Urbanist'] tracking-wide">Qty (KG)</div>
                                       <div className="w-20 justify-center text-indigo-950 text-sm font-bold font-['Urbanist'] tracking-wide">Unit</div>
                                       <div className="min-w-32 justify-center text-indigo-950 text-sm font-bold font-['Urbanist'] tracking-wide">Unit Price</div>
                                       <div className="min-w-32 justify-center text-indigo-950 text-sm font-bold font-['Urbanist'] tracking-wide">Subtotal</div>
                                   </div>
                       
                                   {/* Dynamic rows */}
                                   
                                   {rows.map((row, index) => (
                                       <div key={index} className="self-stretch px-2.5 py-4 bg-white border-b-[0.20px] border-slate-600/40 inline-flex justify-start items-center gap-3.5">
                                           ...
                                           <div className="min-w-32 justify-center text-slate-900 text-sm font-normal font-['Urbanist'] tracking-wide">
                                               <select
                                                   ...
                                                   className="w-full bg-transparent outline-none text-slate-900 -ml-10"
                                               >
                            ...
                            <div className="self-stretch px-4 flex flex-col justify-start items-start gap-12">
                                ...
                                <div className="self-stretch pb-8 border-b border-zinc-100 inline-flex justify-between items-start flex-wrap content-start">
                                    <div className="w-96 flex justify-between items-center">
                                        <label className="w-24 justify-start text-slate-600/40 text-sm font-normal font-['Urbanist']"
                                            htmlFor="commission">
                                            Commission (%)
                                        </label>
                                    ...
                                    <div className="w-96 flex justify-between items-center">
                                        <label className="w-24 justify-start text-slate-600/40 text-sm font-normal font-['Urbanist']" htmlFor="discount">
                                            Discount (%)
                                        </label>
                                        <div className="w-64 h-12 px-6 py-4 bg-gray-50 rounded-xl flex justify-start items-center gap-2">
                                            <input
                                    ...
                                    <div className="flex justify-start items-center gap-2 mt-10">
                                        <label className="w-30 justify-start text-slate-600/40 text-sm font-normal font-['Urbanist']" htmlFor="totalDeductions">
                                            Total Deductions
                                        </label>
                                ...
                                <div className="self-stretch inline-flex justify-between items-start flex-wrap content-start">
                                    <div className="w-96 flex justify-between items-center">
                                        <label className="w-24 justify-start text-slate-600/40 text-sm font-normal font-['Urbanist']" htmlFor="netPayable">
                                            Net Payable
                                        </label>
                                        <div className="w-64 h-12 px-6 py-4 bg-gray-50 rounded-xl flex justify-start items-center gap-3">
                                            <div className="justify-start text-indigo-950 text-xl font-bold font-['Urbanist']">$</div>
