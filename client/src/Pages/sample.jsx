...
const Sample = () => {
  return (
    <div className="w-full h-full p-4 md:p-8 lg:p-12 bg-white rounded-3xl flex flex-col justify-start items-start gap-12 overflow-hidden">
      ...
      <div className="w-full flex flex-wrap justify-between items-start gap-12 md:px-8 lg:px-40">
        ...
        {/* Customer Name */}
        <div className="flex justify-start items-center gap-6 sm:gap-12 w-full sm:w-[570px]">
          <label className="min-w-[120px] sm:min-w-[172px] text-[#737791] text-xl font-normal font-['Urbanist']" htmlFor="customer-name">
            Customer Name <span className="text-red-500 text-xl">*</span>
          </label>
          <input
            id="customer-name"
            type="text"
  ...
  <label htmlFor="sameAsPhone" className="text-[#a1a5b6] text-base font-normal font-['Urbanist']">
    Same as Phone
        ...
        {/* Discount % */}
        <div className="flex justify-start items-center gap-6 sm:gap-12 w-full sm:w-[570px]">
          <label className="min-w-[120px] sm:min-w-[172px] text-[#737791] text-xl font-normal font-['Urbanist']" htmlFor="discount">Discount %</label>
          <input
            id="discount"
            type="number"
            placeholder="Enter here"
        ...
        {/* Discount Applied */}
        <div className="flex justify-start items-center gap-6 sm:gap-12 w-full sm:w-[570px]">
          <label className="min-w-[120px] sm:min-w-[172px] text-[#737791] text-xl font-normal font-['Urbanist']" htmlFor="discount-applied">Discount Applied</label>
          <select
            id="discount-applied"
            className="w-full sm:w-[350px] px-6 py-4 bg-gray-50 rounded-xl text-[#a1a5b6] text-xl font-normal font-['Urbanist']"
          >
        ...
        {/* Route */}
        <div className="flex justify-start items-center gap-6 sm:gap-12 w-full sm:w-[570px]">
          <label className="min-w-[120px] sm:min-w-[172px] text-[#737791] text-xl font-normal font-['Urbanist']" htmlFor="route">Route</label>
          <div className="flex justify-start items-center gap-2">
            <label className="w-[120px] sm:w-[175px] bg-blue-50 text-[#4078ec] text-center py-4 rounded-l-xl" htmlFor="route-yes">
              Yes
            </label>
            <input
              id="route-yes"
              ...
              className="hidden"
            />
            <label className="w-[120px] sm:w-[175px] bg-gray-50 text-[#a1a5b6] text-center py-4 rounded-r-xl" htmlFor="route-no">
              No
            </label>
            <input
              id="route-no"
