...
const editCustomer = async (req, res) => {
  try {
    ...
    existingCustomer.whatsapp = whatsapp;
    existingCustomer.discount = discount;
    existingCustomer.discountApplied = discountApplied;
    existingCustomer.openingBalance = openingBalance;
    existingCustomer.routeCustomer = routeCustomer;
    existingCustomer.routeAddress = routeCustomer ? routeAddress : "";
