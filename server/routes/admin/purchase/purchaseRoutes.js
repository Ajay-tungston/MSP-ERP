...
const { createPurchaseEntry, getAllPurchaseEntries, getPurchaseCounter, getIncompletePurchases, getPurchaseById } = require("../../../controllers/admin/purchse/purchaseController")
