...
const { addNewSupplier, getAllSuppliers, deleteSupplier, getSupplierList, updateSupplier, getSingleSupplier } = require("../../../controllers/admin/supplier/adminSupplierController")
